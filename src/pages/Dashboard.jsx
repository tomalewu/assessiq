...
function RoleCard({ role, candidates, onLink, onBulk, onDelete, onEditThreshold, onViewResult, onNote, onDeleteCand, userIsAdmin, me }) {
...
export default function Dashboard() {
  ...
  const [form, setForm]                   = useState({ title:'', dept:'', threshold:12, isMTO:false, ageLimit:28, recruiterEmail:'' })
