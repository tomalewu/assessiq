...
const LOGIC_HARD = [
  { grid:[['3','6','2'],['5','10','4'],['7','14','?']], options:['5','6','7','8'], answer:"6", exp:"Col2 = Col1 x 2. Col3 = Col1 - 1. Row 3: Col3 = 7-1 = 6." },
  { grid:[['2','5','3'],['4','9','5'],['6','13','?']], options:['6','7','8','9'], answer:"7", exp:"Col2 = Col1 x 2 + 1. Col3 = Col1 + 1. Row 3: 6+1 = 7." },
  { grid:[['1','2','3'],['3','6','9'],['5','10','?']], options:['13','14','15','16'], answer:"15", exp:"Col2 = Col1 x 2. Col3 = Col1 x 3. Row 3: 5 x 3 = 15." },
  { grid:[['4','2','8'],['9','3','27'],['16','4','?']], options:['48','56','64','72'], answer:"64", exp:"Col2 = square root of Col1. Col3 = Col1 x Col2. Row 3: 16 x 4 = 64." },
  { grid:[['6','3','9'],['10','5','15'],['14','7','?']], options:['18','19','20','21'], answer:"21", exp:"Col2 = Col1 / 2. Col3 = Col1 + Col2. Row 3: 14 + 7 = 21." },
  { grid:[['2','4','16'],['3','6','36'],['4','8','?']], options:['48','56','64','72'], answer:"64", exp:"Col2 = Col1 x 2. Col3 = Col2 squared. Row 3: 8 squared = 64." },
  { grid:[['1','3','4'],['4','6','10'],['9','9','?']], options:['16','17','18','19'], answer:"18", exp:"Col1 = perfect squares (1,4,9). Col3 = Col1 + Col2. Row 3: 9 + 9 = 18." },
  { grid:[['5','2','3'],['8','3','5'],['11','4','?']], options:['6','7','8','9'], answer:"7", exp:"Col1 increases by 3. Col2 increases by 1. Col3 = Col1 - Col2 - 2. Row 3: 11-4=7." },
  { grid:[['3','9','6'],['4','16','12'],['5','25','?']], options:['18','20','22','24'], answer:"20", exp:"Col2 = Col1 squared. Col3 = Col1 x (Col1-1). Row 3: 5x4=20." },
  { grid:[['2','3','7'],['3','5','13'],['4','7','?']], options:['17','18','19','20'], answer:"19", exp:"Col3 = 2 x Col2 + Col1. Row 3: 2x7+5=19." },
  { grid:[['1','4','9'],['2','9','25'],['3','16','?']], options:['36','42','49','56'], answer:"49", exp:"Col3 = (Col1+3)^2. Row 3: (3+4)^2 = 49." },
  { grid:[['6','2','4'],['15','3','12'],['28','4','?']], options:['22','24','26','28'], answer:"24", exp:"Col3 = Col1 - Col2. Row 3: 28-4=24." },
  { grid:[['2','6','10'],['3','12','21'],['4','20','?']], options:['30','34','36','40'], answer:"36", exp:"Col3 = Col1 x (Col1 + Col1 - 1). Row 3: 4x9=36." },
  { grid:[['1','0','1'],['4','3','13'],['9','8','?']], options:['71','72','73','74'], answer:"73", exp:"Col3 = Col1 x Col2 + Col1. Row 3: 9x8+1=73." },
  { grid:[['3','4','25'],['5','6','61'],['7','8','?']], options:['100','111','113','115'], answer:"113", exp:"Col3 = Col1^2 + Col2^2. Row 3: 7^2 + 8^2 = 49 + 64 = 113." },
  { grid:[['2','3','5'],['3','4','7'],['5','6','?']], options:['10','11','12','13'], answer:"11", exp:"Col3 = Col1 + Col2. Row 3: 5 + 6 = 11." },
  { grid:[['4','3','48'],['5','4','100'],['6','5','?']], options:['160','168','180','186'], answer:"180", exp:"Col3 = Col1^2 x Col2. Row 3: 36 x 5 = 180." },
  { grid:[['2','?','0'],['0','0','0'],['0','0','0']], options:['3','5','7','11'], answer:"3", exp:"What comes next in the prime number sequence after 2? The next prime is 3." },
  { grid:[['1','4','27'],['2','9','64'],['3','16','?']], options:['100','121','125','128'], answer:"125", exp:"Col2: 2^2,3^2,4^2. Col3: 3^3,4^3,5^3=125." },
  { grid:[['1','1','2'],['3','5','8'],['13','21','?']], options:['29','34','35','37'], answer:"34", exp:"Fibonacci sequence: each number = sum of previous two. 13+21=34." },
  { grid:[['2','3','5'],['7','11','13'],['17','19','?']], options:['21','23','25','27'], answer:"23", exp:"All numbers are prime. Next prime after 19 is 23." },
  { grid:[['1','2','4'],['7','11','16'],['22','29','?']], options:['35','36','37','38'], answer:"37", exp:"Differences: 1,2,3,4,5,6,7,8... Row 3: 29+8=37." },
  { grid:[['3','8','15'],['24','35','48'],['63','80','?']], options:['95','99','100','104'], answer:"99", exp:"Each term = n(n+2): 9x11=99." },
  { grid:[['2','6','12'],['20','30','42'],['56','72','?']], options:['88','90','92','96'], answer:"90", exp:"Each term = n(n+1): 9x10=90." },
  { grid:[['1','8','27'],['64','125','216'],['343','512','?']], options:['625','700','729','800'], answer:"729", exp:"Perfect cubes: 9^3 = 729." },
  { grid:[['1','3','7'],['13','21','31'],['43','57','?']], options:['70','72','73','74'], answer:"73", exp:"Differences increase by 2 each time. After 57: +16=73." },
  { grid:[['2','5','10'],['17','26','37'],['50','65','?']], options:['80','82','83','84'], answer:"82", exp:"Each term = n^2 + 1: 9^2+1=82." },
  { grid:[['0','1','1'],['2','3','5'],['8','13','?']], options:['18','20','21','22'], answer:"21", exp:"Fibonacci: 8+13=21." },
  { grid:[['4','6','10'],['14','20','28'],['38','50','?']], options:['62','64','65','66'], answer:"64", exp:"Differences: 2,4,4,6,6,8,8,10,10,12,12,14: after 50 add 14=64." },
  { grid:[['1','2','6'],['24','120','720'],['5040','40320','?']], options:['282,000','362,880','400,000','420,000'], answer:"362,880", exp:"Factorials: 9!=362,880." },
  { grid:[['1','4','13'],['40','121','364'],['1093','3280','?']], options:['9841','10000','10245','11000'], answer:"9841", exp:"Each term = previous x 3 + 1: 3280x3+1=9841." },
  { grid:[['0','0','0'],['0','0','0'],['0','0','0']], options:['Some analysts are not planners','All analysts are planners','No planners are analysts','Some planners are not managers'], answer:"Some analysts are not planners", exp:"All managers are planners. Some analysts are managers. Some analysts are planners but we cannot confirm all are, so some may not be.", question:"All managers are planners. Some analysts are managers. Which conclusion is definitely valid?" },
  { grid:[['0','0','0'],['0','0','0'],['0','0','0']], options:['Some leaders are not thinkers','All thinkers are doers','No doers are leaders','Some thinkers are leaders'], answer:"Some thinkers are leaders", exp:"All leaders are thinkers. Some doers are leaders. Therefore some doers are thinkers, and some thinkers are leaders.", question:"All leaders are thinkers. Some doers are leaders. Which conclusion must be true?" },
  { grid:[['0','0','0'],['0','0','0'],['0','0','0']], options:['Some engineers are not scientists','All scientists are engineers','No engineers are researchers','Some researchers are scientists'], answer:"Some researchers are scientists", exp:"All scientists are researchers. Some engineers are scientists. Therefore some engineers are researchers, and some researchers are scientists.", question:"All scientists are researchers. Some engineers are scientists. Which conclusion must be true?" },
  { grid:[['0','0','0'],['0','0','0'],['0','0','0']], options:['All creative people are innovative','No analytical people are creative','Some innovative people are analytical','All analytical people are creative'], answer:"Some innovative people are analytical", exp:"All analytical people are innovative. Some creative people are analytical. Therefore some innovative people are analytical.", question:"All analytical people are innovative. Some creative people are analytical. Which must be true?" },
  { grid:[['0','0','0'],['0','0','0'],['0','0','0']], options:['All fast workers are accurate','No accurate workers are experienced','Some experienced workers are not accurate','Some experienced workers are fast'], answer:"Some experienced workers are fast", exp:"All fast workers are experienced. Some accurate workers are fast. Therefore some experienced workers are fast.", question:"All fast workers are experienced. Some accurate workers are fast. Which conclusion is valid?" },
  { grid:[['0','0','0'],['0','0','0'],['0','0','0']], options:['Some optimists are not achievers','All achievers are optimists','No leaders are achievers','Some leaders are not optimists'], answer:"All achievers are optimists", exp:"All leaders are optimists. All achievers are leaders. By transitivity: All achievers are optimists.", question:"All leaders are optimists. All achievers are leaders. Which conclusion must be true?" },
  { grid:[['0','0','0'],['0','0','0'],['0','0','0']], options:['Some strategists are not visionaries','All visionaries are strategists','No executors are strategists','Some executors are visionaries'], answer:"Some executors are visionaries", exp:"All strategists are visionaries. Some executors are strategists. Therefore some executors are visionaries.", question:"All strategists are visionaries. Some executors are strategists. Which must be true?" },
  { grid:[['0','0','0'],['0','0','0'],['0','0','0']], options:['If it rained, the match was cancelled','The match was not cancelled','It did not rain','It rained and the match was cancelled'], answer:"It did not rain", exp:"If P then Q. Not Q. Therefore Not P. Modus tollens: it did not rain.", question:"If it rained, the match would be cancelled. The match was not cancelled. What can you conclude?" },
  { grid:[['0','0','0'],['0','0','0'],['0','0','0']], options:['Sara passed the exam','Sara studied hard','Sara did not study hard','Nothing can be concluded'], answer:"Nothing can be concluded", exp:"Affirming the consequent is a fallacy. Sara passing does not confirm she studied hard.", question:"Everyone who studies hard passes the exam. Sara passed the exam. What can you conclude?" },
  { grid:[['0','0','0'],['0','0','0'],['0','0','0']], options:['All high earners are happy','No happy people are hard workers','Some hard workers are happy','No hard workers are high earners'], answer:"Some hard workers are happy", exp:"All high earners are happy. Some hard workers are high earners. Therefore some hard workers are happy.", question:"All high earners are happy. Some hard workers are high earners. Which must be true?" },
  { grid:[['0','0','0'],['0','0','0'],['0','0','0']], options:['Ahmed is telling the truth','Bilal is lying','Exactly one of them is lying','Both could be telling the truth'], answer:"Exactly one of them is lying", exp:"Ahmed says Bilal is lying. Bilal says Ahmed is honest. The only consistent resolution: exactly one lies.", question:"Ahmed says 'Bilal is lying.' Bilal says 'Ahmed is telling the truth.' What must be true?" },
  { grid:[['0','0','0'],['0','0','0'],['0','0','0']], options:['Project failed due to poor planning','No conclusion can be drawn about cause','All failed projects lacked resources','Poor planning always causes failure'], answer:"No conclusion can be drawn about cause", exp:"Correlation is not causation. The fact that failed projects often lacked resources does not prove causation.", question:"A study finds that 80% of failed projects had insufficient resources. A project just failed. What can you conclude?" },
  { grid:[['0','0','0'],['0','0','0'],['0','0','0']], options:['The device is faulty','The power is off','Either power is off or the device is faulty','Both conditions must be true'], answer:"Either power is off or the device is faulty", exp:"The device not turning on implies power off OR device faulty. We cannot determine which without more info.", question:"A device does not turn on when the button is pressed. The button is functional. What can be concluded?" },
  { grid:[['0','0','0'],['0','0','0'],['0','0','0']], options:['Some risk-takers are not successful','All successful people are risk-takers','No cautious people are successful','Some cautious people are successful'], answer:"Some cautious people are successful", exp:"This is stated directly in the premises — some cautious people are successful.", question:"All risk-takers are successful. Some cautious people are also successful. Which must be true?" },
  { grid:[['0','0','0'],['0','0','0'],['0','0','0']], options:['The manager made the right decision','High ROI projects always succeed','The project success cannot be attributed solely to ROI','Low-ROI projects always fail'], answer:"The project success cannot be attributed solely to ROI", exp:"Multiple factors influence project success. Success cannot be attributed solely to ROI forecast.", question:"Projects with high ROI forecasts succeed 70% of the time. This project had a high ROI forecast and succeeded. What follows?" },
  { grid:[['0','0','0'],['0','0','0'],['0','0','0']], options:['Z is definitely the most productive','X is less productive than Y','W is the least productive','Y is more productive than Z'], answer:"X is less productive than Y", exp:"W > X and Y > W gives Y > W > X. Therefore X is less productive than Y.", question:"W is more productive than X. Y is more productive than W. What can be concluded?" },
]
...
const NUM_MEDIUM = [
  ...
  { question:"A boat travels 24km upstream in 3h and same distance downstream in 2h. Speed of stream?", tableHtml:null, options:['1km/h','2km/h','3km/h','4km/h'], answer:"2km/h", exp:"Upstream=8km/h, downstream=12km/h; stream=(12-8)/2=2km/h." },
...
// ── HARD Numerical (50 questions) — 4 errors corrected ────────────────
const NUM_HARD = [
  ...
  // FIX 1: Changed drain pipe from 12h to 36h so answer is exactly 4h
  { question:"Two pipes fill a tank in 6h and 9h. Third pipe drains in 36h. Time to fill with all open?", tableHtml:null, options:['3h','4h','5h','6h'], answer:"4h", exp:"1/6 + 1/9 - 1/36 = 6/36+4/36-1/36 = 9/36 = 1/4; time = 4h." },
  ...
  // FIX 2: Changed options and answer to match correct calculation of 12.6%
  { question:"Stock price: +12%, -8%, +15%, -5%. Net percentage change from start?", tableHtml:null, options:['11.8%','12.6%','13.2%','14.0%'], answer:"12.6%", exp:"1.12 x 0.92 x 1.15 x 0.95 = 1.1257; net change = 12.6%." },
  ...
  { question:"A boat goes 30km upstream in 3h and 30km downstream in 1.5h. Speed of current?", tableHtml:null, options:['4km/h','5km/h','6km/h','7km/h'], answer:"5km/h", exp:"Upstream=10km/h, downstream=20km/h; current=(20-10)/2=5km/h." },
  ...
  { question:"A trader sells at 20% profit. Cost increases 10%, selling price unchanged. New profit %?", tableHtml:null, options:['8.0%','9.1%','10.0%','11.2%'], answer:"9.1%", exp:"SP=1.2C; new cost=1.1C; profit=(1.2C-1.1C)/1.1C=9.09% approx 9.1%." },
  ...
  // FIX 3: Changed options and answer from 81.2 to 81.7 (correct calculation)
  { question:"What is the weighted average score?", tableHtml:'<table class="ntbl"><tr><th>Subject</th><th>Score</th><th>Weight</th></tr><tr><td>Math</td><td>85</td><td>40%</td></tr><tr><td>English</td><td>72</td><td>35%</td></tr><tr><td>Science</td><td>90</td><td>25%</td></tr></table>', options:['80.2','81.7','82.5','83.5'], answer:"81.7", exp:"0.4x85+0.35x72+0.25x90=34+25.2+22.5=81.7." },
  ...
  { question:"An item sold at 15% loss. If sold at $120 more, profit would be 10%. Cost price?", tableHtml:null, options:['$450','$480','$500','$520'], answer:"$480", exp:"1.10C - 0.85C = 120; 0.25C=120; C=$480." },
  ...
  { question:"A portfolio: 40% stocks (12%), 35% bonds (6%), 25% cash (2%). Overall return?", tableHtml:null, options:['7.0%','7.2%','7.4%','8.0%'], answer:"7.4%", exp:"0.4x12+0.35x6+0.25x2=4.8+2.1+0.5=7.4%." },
  ...
  { question:"3 workers A, B, C complete work in 10, 12, 15 days. All work 3 days then A leaves. B and C finish. Total days?", tableHtml:null, options:['6 days','7 days','8 days','9 days'], answer:"7 days", exp:"Together rate=1/4; 3days=3/4 done; B+C rate=3/20; remaining 1/4 at 3/20=5/3 days; total approx 7." },
  ...
  // FIX 4: Changed options and answer from $15,110 to $14,758 (correct calculation)
  { question:"What is the NPV at 10% discount rate?", tableHtml:'<table class="ntbl"><tr><th>Year</th><th>Cash Flow</th><th>Discount Factor</th></tr><tr><td>1</td><td>$5,000</td><td>0.909</td></tr><tr><td>2</td><td>$6,000</td><td>0.826</td></tr><tr><td>3</td><td>$7,000</td><td>0.751</td></tr></table>', options:['$13,900','$14,758','$15,200','$15,900'], answer:"$14,758", exp:"5000x0.909+6000x0.826+7000x0.751=4545+4956+5257=$14,758." },
